...
INSERT INTO "Cristian"."TEST" (TEST_ID, NOMBRE, DESCRIPCION, PROGRAMA, UNIDAD, AUTOR, FECHA_CREACION) VALUES ('1', 'Test Base de datos', 'Resolver BBDD', 'Full Stack', 'Unidad 2', 'Felipe Awaker', '13-03-2020')
INSERT INTO "Cristian"."PREGUNTAS" (PREGUNTAS_ID, TEST_TEST_ID, ENUNCIADO, PUNTAJE) VALUES ('1', '1', 'Responda la pregunta', '50')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', '1', '1', '1')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', '1', '1', '1')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', 'Defina BBDD', 'VERDADERO', '30')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', 'Es un conjunto de datos pertenecientes a un mismo contexto', '1', '1')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', 'Es un conjunto de datos pertenecientes a un mismo contexto', '1', '1')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID) VALUES ('1', '1')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', 'Es un conjunto de datos pertenecientes a un mismo contexto', 'CIEN', 'CIEN')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', 'Es un conjunto de datos pertenecientes a un mismo contexto', 'CIEN', 'CIEN')
INSERT INTO "Cristian"."RESPUESTAS" (RESPUESTAS_ID, RESULTADO) VALUES ('1', 'VERDADERO')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', 'es un conjunto de datos pertenecientes a un mismo contexto', '10', '20')
INSERT INTO "Cristian"."ALTERNATIVAS" (RESPUESTAS_RESPUESTAS_ID, PREGUNTAS_PREGUNTAS_ID, DESCRIPCION, VALOR_LOGICO, PORCENTAJE) VALUES ('1', '1', '1', '1', '1')
INSERT INTO "Cristian"."ESTUDIANTES" (CURSO_CURSO_ID, NOMBRE, APELLIDO, RUT) VALUES ('24', 'Claudio', 'Mondaca', '13456765-4')
INSERT INTO "Cristian"."ESTUDIANTES" (CURSO_CURSO_ID, NOMBRE, APELLIDO, RUT) VALUES ('24', 'Cristian', 'Olivas', '166681499')
